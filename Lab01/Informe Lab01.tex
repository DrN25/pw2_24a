...
\pagestyle{fancy}
\lhead{\begin{picture}(0,0) \put(0,-8){\includegraphics[width=20mm]{img/logoFips.png}} \end{picture}}
\rhead{\begin{picture}(0,0) \put(-25,10){\includegraphics[width=8mm]{./img/logoAbet.png}} \end{picture}}
